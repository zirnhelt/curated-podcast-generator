...
def write_citations(tag, date_str, all_articles, script, debate_summary, output_dir):
    ...
    citations = {
        ...
        "credits": {
            ...
            "text_to_speech": _bespoke_tts_credit(),
...
def write_show_notes(tag, date_str, all_articles, debate_summary, output_dir):
    ...
    lines += [
        ...
        f"*Generated by Claude (Anthropic) · Script Review: {POLISH_MODEL} · Audio by {_bespoke_tts_credit()} · Sources via Brave Search*",
    ]
