# Cariboo Signals — Community Content Compact Self-Assessment

*Assessed against the Creative Content Accountability Framework*
...
Cariboo Signals qualifies for **Track A — Community-Insider Production** on all four criteria:

|Criterion                                                |Status                                                          |
|---------------------------------------------------------|----------------------------------------------------------------|
|Producer is a community member or deeply embedded        |✓ Erich Zirnhelt, resident of Horsefly, BC (Secwépemc territory)|
|No commercial revenue model                              |✓ No advertising, licensing, or subscription income             |
|Self-funded or micro-funded                              |✓ ~$4/month in API fees, self-funded                            |
|Primary audience is the community or adjacent communities|✓ Cariboo-region focus                                          |
...
## Notes on Previous Assessments

An earlier informal estimate in this project's development conversation scored Cariboo Signals at approximately 18/20 and applied the N/A rule to C1 and C2 on the basis that no living people are quoted. This was incorrect. PSA organizations featured in each episode are representations of real entities and clear that threshold. The corrected score above reflects proper application of the framework.

Any scoring table showing totals out of 35 or using verdict labels from Track B (Extractive / High Risk / Conditional / Defensible / Community-Serving) is a misapplication — Track A is scored out of 20 with its own verdict vocabulary.

-----

*Framework: `community-content-compact/framework.md`*
*Assessed by: Erich Zirnhelt with Claude, May 2026*
